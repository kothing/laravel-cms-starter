...
!(function (t, e) {
        ...
        off(t, e, i, s) {
            ...
            if (void 0 === o) {
                ...
                for (const [i, s] of Object.entries(c)) {
                    const n = i.replace(C, "");
                    (a && !e.includes(n)) ||
                        x(t, l, r, s.callable, s.delegationSelector);
                }
            } else {
    ...
    const q = {
        ...
        getDataAttributes(t) {
            ...
            for (const s of i) {
                let i = s.replace(/^coreui/, "");
                (i = i.charAt(0).toLowerCase() + i.slice(1, i.length)),
                    (e[i] = z(t.dataset[s]));
            }
            return e;
        },
        getDataAttribute: (t, e) => z(t.getAttribute(`data-coreui-${H(e)}`)),
    };
    class B {
        static get Default() {
            return {};
    ...
    const V = (t) => {
        ...
        K = (t, e = "hide") => {
            const i = `click.dismiss${t.EVENT_KEY}`,
                s = t.NAME;
            j.on(document, i, `[data-coreui-dismiss="${s}"]`, function (i) {
                if (
                    ...
                    return;
                const n =
                    R.getElementFromSelector(this) || this.closest(`.${s}`);
    ...
    K(X, "close"), b(X);
    const G = '[data-coreui-toggle="button"]';
    class J extends W {
        static get NAME() {
            return "button";
        }
    ...
    j.on(document, "click.coreui.button.data-api", G, (t) => {
        t.preventDefault();
        const e = t.target.closest(G);
        J.getOrCreateInstance(e).toggle();
    }),
        b(J);
    const Z = ".coreui.swipe",
        tt = `touchstart${Z}`,
        et = `touchmove${Z}`,
        it = `touchend${Z}`,
        st = `pointerdown${Z}`,
    ...
    class Ot extends W {
        ...
        _setActiveIndicatorElement(t) {
            ...
            const e = R.findOne(Ct, this._indicatorsElement);
        ...
        _getActive() {
            return R.findOne(kt, this._element);
        }
        _getItems() {
            return R.find(Tt, this._element);
        }
        _clearInterval() {
            this._interval &&
    ...
    j.on(
        ...
        j.on(window, yt, () => {
            const t = R.find('[data-coreui-ride="carousel"]');
            for (const e of t) Ot.getOrCreateInstance(e);
        }),
        b(Ot);
    const Nt = ".coreui.collapse",
        It = `show${Nt}`,
        Dt = `shown${Nt}`,
        xt = `hide${Nt}`,
        Mt = `hidden${Nt}`,
    ...
    class Vt extends W {
        ...
        show() {
            ...
            if (
                ...
                return;
            if (j.trigger(this._element, It).defaultPrevented) return;
        ...
        _getFirstLevelChildren(t) {
            const e = R.find(Ht, this._config.parent);
    ...
    j.on(document, Pt, qt, function (t) {
        ("A" === t.target.tagName ||
    ...
    const Rt = "dropdown",
        ...
        ie = `keyup${Kt}${Qt}`,
        se = "show",
        ne = '[data-coreui-toggle="dropdown"]:not(.disabled):not(:disabled)',
        oe = `${ne}.${se}`,
        re = ".dropdown-menu",
    ...
    class fe extends W {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    R.next(this._element, re)[0] ||
                    R.prev(this._element, re)[0] ||
                    R.findOne(re, this._parent)),
        ...
        _completeHide(t) {
            if (!j.trigger(this._element, Xt, t).defaultPrevented) {
        ...
        static dataApiKeydownHandler(t) {
            ...
            const n = this.matches(ne)
                    ...
                    : R.prev(this, ne)[0] ||
                      R.next(this, ne)[0] ||
                      R.findOne(ne, t.delegateTarget.parentNode),
    ...
    class De {
        ...
        hide() {
            ...
            this._disableOverFlow(),
                ...
                this._setElementAttributes(Se, Ne, (e) => e + t),
                this._setElementAttributes(Oe, Ie, (e) => e - t);
        }
        reset() {
            this._resetElementAttributes(this._element, "overflow"),
                this._resetElementAttributes(this._element, Ne),
                this._resetElementAttributes(Se, Ne),
                this._resetElementAttributes(Oe, Ie);
        }
        isOverflowing() {
    ...
    const xe = ".coreui.modal",
        ...
        He = `resize${xe}`,
        qe = `click.dismiss${xe}`,
        Be = `mousedown.dismiss${xe}`,
        We = `keydown.dismiss${xe}`,
        Ve = `click${xe}.data-api`,
        Re = "modal-open",
        Ke = "show",
        Qe = "modal-static",
    ...
    class Xe extends W {
        ...
        _addEventListeners() {
            j.on(this._element, We, (t) => {
                ...
                j.on(this._element, Be, (t) => {
                    j.one(this._element, qe, (e) => {
    ...
    j.on(document, Ve, '[data-coreui-toggle="modal"]', function (t) {
        const e = R.getElementFromSelector(this);
        ...
        i && Xe.getInstance(i).hide(), Xe.getOrCreateInstance(e).toggle(this);
    }),
        K(Xe),
        b(Xe);
    const Ge = "coreui.navigation",
        Je = `.${Ge}`,
        Ze = ".data-api",
        ti = { activeLinksExact: !0, groupsAutoCollapse: !0 },
        ei = {
    ...
    class hi extends W {
        ...
        _setActiveLink() {
            for (const t of Array.from(
                ...
                if (t.classList.contains(ni)) continue;
                let e = String(window.location);
                const i = /\?./,
                    s = /#./;
                (/\?.*=/.test(e) || i.test(e)) && (e = e.split("?")[0]),
                    s.test(e) && (e = e.split("#")[0]),
                    this._config.activeLinksExact &&
                        t.href === e &&
                        (t.classList.add(ii),
                        Array.from(this._getParents(t, ai)).forEach((t) => {
                            t.classList.add(si),
        ...
        _toggleGroupItems(t) {
            let e = t.target;
            e.classList.contains(ni) || (e = e.closest(ci));
            const i = (t) =>
                Boolean(
            ...
            if (!0 === this._config.groupsAutoCollapse)
                for (const t of this._getSiblings(e.parentNode, i))
                    this._slideUp(R.findOne(li, t), () => {
                        t.classList.remove(si),
                            t.setAttribute("aria-expanded", !1);
                    });
            e.parentNode.classList.contains(si)
                ? this._slideUp(R.findOne(li, e.parentNode), () => {
                      e.parentNode.classList.remove(si),
                          e.parentNode.setAttribute("aria-expanded", !1);
                  })
                : (e.parentNode.classList.add(si),
                  e.parentNode.setAttribute("aria-expanded", !0),
                  this._slideDown(R.findOne(li, e.parentNode)));
        }
        _addEventListeners() {
            j.on(this._element, oi, ci, (t) => {
                t.preventDefault(), this._toggleGroupItems(t, this);
            });
        }
        static navigationInterface(t, e) {
            const i = hi.getOrCreateInstance(t, e);
            if ("string" == typeof e) {
                if (void 0 === i[e])
    ...
    j.on(window, ri, () => {
        for (const t of Array.from(
            ...
            hi.navigationInterface(t);
    }),
        b(hi);
    const di = ".coreui.offcanvas",
        ui = ".data-api",
        _i = `load${di}${ui}`,
        gi = "show",
        fi = "showing",
    ...
    class $i extends W {
        ...
        show(t) {
            this._isShown ||
                j.trigger(this._element, bi, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
                this._backdrop.show(),
                ...
                this._queueCallback(
                    () => {
                        (this._config.scroll && !this._config.backdrop) ||
                            ...
                            j.trigger(this._element, vi, { relatedTarget: t });
                    },
                    this._element,
                    !0
                ));
        ...
        hide() {
            this._isShown &&
                (j.trigger(this._element, yi).defaultPrevented ||
                    (this._focustrap.deactivate(),
                    this._element.blur(),
                    (this._isShown = !1),
    ...
    j.on(document, Ci, '[data-coreui-toggle="offcanvas"]', function (t) {
        const e = R.getElementFromSelector(this);
        if (
            (["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            d(this))
        ...
        const i = R.findOne(pi);
        i && i !== e && $i.getInstance(i).hide(),
            $i.getOrCreateInstance(e).toggle(this);
    }),
        j.on(window, _i, () => {
            for (const t of R.find(pi)) $i.getOrCreateInstance(t).show();
        }),
        j.on(window, Ei, () => {
    ...
    const Si = {
        ...
        Ni = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i,
        Ii = (t, e) => {
            const i = t.nodeName.toLowerCase();
            return e.includes(i)
                ? !Oi.has(i) || Boolean(Ni.test(t.nodeValue))
    ...
    class Qi extends W {
        ...
        dispose() {
            clearTimeout(this._timeout),
                j.off(this._element.closest(Hi), qi, this._hideModalHandler),
        ...
        _createTipElement(t) {
            ...
            return (
                e.setAttribute("id", i),
                this._isAnimated() && e.classList.add(Fi),
                e
            );
        }
        setContent(t) {
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ("click" === e)
                    ...
                    j.on(this._element, t, this._config.selector, (t) => {
                        ...
                        (e._activeTrigger["focusin" === t.type ? Wi : Bi] = !0),
                            e._enter();
                    }),
                        j.on(this._element, i, this._config.selector, (t) => {
                            const e = this._initializeOnDelegatedTarget(t);
                            (e._activeTrigger["focusout" === t.type ? Wi : Bi] =
            ...
            (this._hideModalHandler = () => {
                ...
                j.on(this._element.closest(Hi), qi, this._hideModalHandler);
        }
        _fixTitle() {
    ...
    const Gi = ".coreui.scrollspy",
        ...
        is = "[href]",
        ss = ".nav-link",
        ns = `${ss}, .nav-item > ${ss}, .list-group-item`,
        os = {
            offset: null,
    ...
    class as extends W {
        ...
        _maybeEnableSmoothScroll() {
            this._config.smoothScroll &&
                ...
                j.on(this._config.target, Zi, is, (t) => {
        ...
        _initializeTargetsAndObservables() {
            (this._targetLinks = new Map()),
                (this._observableSections = new Map());
            const t = R.find(is, this._config.target);
            for (const e of t) {
        ...
        _process(t) {
            this._activeTarget !== t &&
                ...
                j.trigger(this._element, Ji, { relatedTarget: t }));
        }
        _activateParents(t) {
            if (t.classList.contains("dropdown-item"))
                ...
                for (const e of R.parents(t, ".nav, .list-group"))
                    for (const t of R.prev(e, ns)) t.classList.add(es);
        }
        _clearActiveClass(t) {
            t.classList.remove(es);
            const e = R.find(`${is}.${es}`, t);
    ...
    j.on(window, ts, () => {
        for (const t of R.find('[data-coreui-spy="scroll"]'))
    ...
    class Es extends W {
        ...
        unfoldable() {
            this._isMobile() ||
                (this._addClassName(fs), (this._unfoldable = !0));
        }
        reset() {
            this._isMobile() ||
                (this._narrow &&
        ...
        _addEventListeners() {
            this._mobile && this._show && this._addClickOutListener(),
                ...
                j.on(this._element, ys, "[data-coreui-toggle]", (t) => {
                    t.preventDefault();
                    const e = q.getDataAttribute(t.target, "toggle");
        ...
        static sidebarInterface(t, e) {
            const i = Es.getOrCreateInstance(t, e);
            if ("string" == typeof e) {
                if (void 0 === i[e])
                    throw new TypeError(`No method named "${e}"`);
                i[e]();
        ...
        static jQueryInterface(t) {
            return this.each(function () {
                Es.sidebarInterface(this, t);
            });
        }
    }
    j.on(window, ws, () => {
        for (const t of Array.from(document.querySelectorAll(As)))
            Es.sidebarInterface(t);
    }),
        b(Es);
    const Cs = ".coreui.tab",
        Ts = `hide${Cs}`,
        ...
        Vs = `.nav-link${Bs}, .list-group-item${Bs}, [role="tab"]${Bs}, ${Ws}`,
        Rs = `.${Fs}[data-coreui-toggle="tab"], .${Fs}[data-coreui-toggle="pill"], .${Fs}[data-coreui-toggle="list"]`;
    class Ks extends W {
        constructor(t) {
            super(t),
        ...
        show() {
            ...
            j.trigger(t, Ls, { relatedTarget: e }).defaultPrevented ||
                    ...
                    () => {
                        "tab" === t.getAttribute("role")
                            ? (t.setAttribute("aria-selected", !1),
                              ...
                              j.trigger(t, ks, { relatedTarget: e }))
        ...
        _keydown(t) {
            if (![Is, Ds, xs, Ms, Ps, js].includes(t.key)) return;
            t.stopPropagation(), t.preventDefault();
            const e = this._getChildren().filter((t) => !d(t));
            let i;
            if ([Ps, js].includes(t.key))
                i = e[t.key === Ps ? 0 : e.length - 1];
            else {
                const s = [Ds, Ms].includes(t.key);
                i = w(e, t.target, s, !0);
            }
            i &&
        ...
        _getInnerElement(t) {
            return t.matches(Vs) ? t : R.findOne(Vs, t);
        }
        _getOuterElement(t) {
    ...
    j.on(document, Ss, Ws, function (t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            d(this) || Ks.getOrCreateInstance(this).show();
    }),
        j.on(window, Ns, () => {
            for (const t of R.find(Rs)) Ks.getOrCreateInstance(t);
        }),
        b(Ks);
    const Qs = ".coreui.toast",
        Us = `mouseover${Qs}`,
        Ys = `mouseout${Qs}`,
        Xs = `focusin${Qs}`,
        Gs = `focusout${Qs}`,
    ...
    class ln extends W {
        ...
        show() {
            j.trigger(this._element, tn).defaultPrevented ||
                (this._clearTimeout(),
        ...
        hide() {
            this.isShown() &&
                (j.trigger(this._element, Js).defaultPrevented ||
                    (this._element.classList.add(on),
                    this._queueCallback(
                        () => {
                            this._element.classList.add(sn),
                                this._element.classList.remove(on, nn),
                                j.trigger(this._element, Zs);
                        },
                        this._element,
                        this._config.animation
                    )));
        ...
        dispose() {
            this._clearTimeout(),
                this.isShown() && this._element.classList.remove(nn),
                super.dispose();
        }
        isShown() {
        ...
        _setListeners() {
            j.on(this._element, Us, (t) => this._onInteraction(t, !0)),
                j.on(this._element, Ys, (t) => this._onInteraction(t, !1)),
                j.on(this._element, Xs, (t) => this._onInteraction(t, !0)),
                j.on(this._element, Gs, (t) => this._onInteraction(t, !1));
        }
        _clearTimeout() {
