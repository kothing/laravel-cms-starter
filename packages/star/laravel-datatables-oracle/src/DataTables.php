...
use Star\DataTables\Exceptions\Exception;
use Star\DataTables\Html\Builder;
...
class DataTables
{
     ...
     *
     * @var \Star\DataTables\Html\Builder|null
     */
        ...
        foreach ($builders as $class => $engine) {
            if ($source instanceof $class) {
                ...
                if (is_callable($callback)) {
                    /** @var \Star\DataTables\DataTableAbstract $instance */
     ...
     * Get request object.
     *
     * @return \Star\DataTables\Utilities\Request
     */
     ...
     * Get config instance.
     *
     * @return \Star\DataTables\Utilities\Config
     */
     ...
     * @return \Star\DataTables\QueryDataTable
     */
     ...
     * @return \Star\DataTables\EloquentDataTable
     */
     ...
     * @return \Star\DataTables\CollectionDataTable
     */
     ...
     *
     * @return \Star\DataTables\Html\Builder
     *
     * @throws \Star\DataTables\Exceptions\Exception
     */
    public function getHtmlBuilder()
    {
        if (! class_exists(Builder::class)) {
            throw new Exception('Please install star/laravel-datatables-html to be able to use this function.');
        }
