...
use Star\DataTables\Contracts\DataTable;
use Star\DataTables\Contracts\Formatter;
use Star\DataTables\Processors\DataProcessor;
use Star\DataTables\Utilities\Helper;
 ...
 *
 * @see https://github.com/star/laravel-datatables-fractal for transformer related methods.
 */
abstract class DataTableAbstract implements DataTable
{
     ...
     *
     * @var \Star\DataTables\Utilities\Request
     */
    ...
    /**
     * @var \Star\DataTables\Utilities\Config
     */
     ...
     * @param  string|callable|\Star\DataTables\Contracts\Formatter  $formatter
     * @return $this
     */
    ...
    {
        if (isset($this->transformer) && class_exists('Star\\DataTables\\Transformers\\FractalTransformer')) {
     ...
     * @return \Illuminate\Http\JsonResponse
     *
     * @throws \Star\DataTables\Exceptions\Exception|\Exception
     */
