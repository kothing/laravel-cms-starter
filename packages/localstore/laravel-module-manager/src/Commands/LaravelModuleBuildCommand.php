...
namespace LocalStore\LaravelModuleManager\Commands;

use Illuminate\Console\Command;
use Illuminate\Support\Facades\File;
use Illuminate\Support\Str;

class LaravelModuleBuildCommand extends Command
{
    /**
    ...
    public function generate($moduleName, $force)
    {
        ...
        $namespaceLower = Str::lower($config['namespace']);
        ...
        $search = ['{{moduleName}}', '{{moduleNamePlural}}', '{{moduleNameLower}}', '{{moduleNameLowerPlural}}', '{{namespace}}', '{{namespaceLower}}', '{{composerPackages}}', '{{composerAuthor}}', '{{composerAuthorEmail}}'];
        $replace = [$moduleName, $moduleNamePlural, $moduleNameLower, $moduleNameLowerPlural, $namespace, $namespaceLower, $composerVendor, $composerAuthor, $composerAuthorEmail];

        $basePath = $namespaceLower.'/'.$moduleName;
